...
function processMainData(err,rows) {
    ...
    mainMessage.innerHTML = "<b> &nbsp;&nbsp;Welcome to the Amazon Seller Category Discovery Tool!</b> Amazon has over 20,000 categories, but your product can only go to <b>one</b> of these (and its parent categories). This tool can help pick the right category for your product by providing comparisons between the categories. \
